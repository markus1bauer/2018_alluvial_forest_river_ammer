...
turbance as a measure to maintain the grey-alder forest in the
long term."
...
dataset <- list(
    title = "Alluvial forest vegetation in an active and inactive
    alpine floodplain – a case study from River Ammer (Bavaria)",
    creator = creator,
    pubDate = "2018",
    language = "English",
