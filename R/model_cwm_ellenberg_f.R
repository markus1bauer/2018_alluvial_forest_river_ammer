# Model for Ellenberg Ellenberg F value ####
# Markus Bauer
...
sites <- read_csv("data_processed_sites.csv", col_names = TRUE,
  ...
  select(id, treatment, cwmAbuF) %>%
  rename(value = cwmAbuF)
...
### Save ###
write.csv(tidytable, here("outputs", "statistics", "table_anova_ellenberg_f.csv"))
